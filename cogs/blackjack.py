    ...
    async def bj(self, ctx: commands.Context, bet: str):
        ...
        try:
            ...
            if str(ctx.author.id) not in guild_data["coins"]:
                embed = discord.Embed(
                    title="Lol, Good Try!",
                    description=f"Please Init your account first",
                ...
                embed = discord.Embed(
                    title="Lol, BrOkE!",
                    description=f"You have no pinecones",
                    color=discord.Color.red(),
                )
                return await ctx.send(embed=embed)
                ...
                return await ctx.send(
                    embed=discord.Embed(
                        description="Invalid Bet", colour=discord.Colour.red()
                    )
                )
            ...
            while True:
                ...
                if response.content.lower() == "h" or "hit" in response.content.lower():
                    ...
                    response.content.lower() == "s"
                    or "stand" in response.content.lower()
                ):
                    break
