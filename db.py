...
class Database(object):
	...
	@staticmethod
	async def replace_one(collection:str, query:dict = {}, data:dict = {}, upsert:bool = False):
	...
	async def get_guild(guild_id: int):
		guild_data = await Database.find_one(Database.GUILDS_COLLECTION, {"GUILD_ID":guild_id})
	...
	async def set_guild(guild_id: int, new_guild_data: dict):
		return await Database.replace_one(Database.GUILDS_COLLECTION, {"GUILD_ID":guild_id}, new_guild_data, True)
